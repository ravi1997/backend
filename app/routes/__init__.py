...
def register_blueprints(app):
    ...
    app.register_blueprint(library_bp, url_prefix='/form/api/v1/templates', name='form_templates')
    ...
    app.register_blueprint(dashboard_settings_bp, url_prefix='/api/v1/dashboard')
